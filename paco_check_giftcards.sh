...
if [ -z "$4" ]; then
  googleSheet="1CoymqkfnOBYorT5rc3BbZaUyWJvkCDpmKoEKQZaHlzA"
  echo 'OPTIONAL parameter for google sheet not specified'
  echo 'using default Paco Orders Google Sheet'
  echo 'https://docs.google.com/spreadsheets/d/1CoymqkfnOBYorT5rc3BbZaUyWJvkCDpmKoEKQZaHlzA'
fi
